...
public class CellsAlignedDisplay extends SingleTextHud {
    ...
    protected String getText(boolean example) {
        ...
        return OwnwnAddons.utils.roundNum(timeLeft) + "s";

    }

    @Override
    public boolean shouldShow() {
        return super.shouldShow() && OwnwnAddons.utils.checkLocMap("Dungeon");
//        return super.shouldShow();
    ...
    public void onChat(ClientChatReceivedEvent event) {
        ...
        String unformatted = OwnwnAddons.utils.stripFormatting(text);
